...
public class Infix_to_PostFix {
    public static String convert_to_Postfix(String str){
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (ch>='0' && ch<='9') {
                ...
                String n2=value.pop();
                String n1=value.pop();
                String stri=n1+n2+characters.pop();
                value.push(stri);
                characters.push(ch);
            }
        ...
        while (characters.size()>0) {
            String n2=value.pop();
            String n1=value.pop();
            value.push(n1+n2+characters.pop());
        }
        return value.pop();
    }
    ...
    public static String solvePostfix_with_bracket(String str) {
        Stack<String> value= new Stack<>();
    ...
    public static void main(String[] args) { 
        System.out.println(convert_to_Postfix("9-5+3*4/6"));
    }
}
